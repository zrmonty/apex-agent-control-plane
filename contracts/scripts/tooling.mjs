...
export const sources = ["control", "governance", "mcp_proxy", "proxy_approval", "proxy_trace", "proxy_management", "proxy_runtime", "proxy_runtime_authority", "proxy_runtime_deployment"];
