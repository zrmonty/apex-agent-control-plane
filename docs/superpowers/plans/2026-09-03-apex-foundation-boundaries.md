...
- [ ] **Step 3: Make workspace metadata resolve without changing package identity**
...
- [ ] **Step 1: Add the contract crate manifest and workspace member**
...
- [ ] **Step 2: Move event code generation and the redacted codec**
...
- [ ] **Step 3: Expose the generated event module**
...
- [ ] **Step 4: Re-export the contract from event-ingest during migration**
...
- [ ] **Step 5: Run contract and event-ingest tests**
...
- [ ] **Step 1: Move validation and error modules with their unit tests**
...
- [ ] **Step 2: Add the domain crate manifest and public surface**
...
- [ ] **Step 3: Move permission helpers into the domain crate**
...
- [ ] **Step 4: Rewire event-ingest and control-plane-api imports**
...
- [ ] **Step 5: Run the moved unit and dependent integration tests**
...
- [ ] **Step 1: Move auth and ephemeral modules with tests**
...
- [ ] **Step 2: Define the crate surface and feature flags**
...
- [ ] **Step 3: Rewire both applications**
...
- [ ] **Step 4: Run authentication and feature-matrix tests**
...
- [ ] **Step 5: Commit the auth extraction**
...
- [ ] **Step 1: Move the security modules and their tests**
...
- [ ] **Step 2: Add the security crate manifest and public exports**
...
- [ ] **Step 3: Rewire the ingest adapter**
...
- [ ] **Step 5: Commit the security extraction**
...
- [ ] **Step 1: Move durability modules without redesigning their behavior**
...
- [ ] **Step 2: Keep the fanout worker as a separate ownership boundary**
...
- [ ] **Step 3: Add a regression test for ACK-before-downstream behavior**
...
- [ ] **Step 4: Rewire event-ingest and control-plane-api**
...
- [ ] **Step 5: Run durability and live-adjacent tests**
...
- [ ] **Step 6: Commit the durability extraction**
...
- [ ] **Step 1: Replace every control-plane application import**
...
- [ ] **Step 2: Remove the path dependency and unused features**
...
- [ ] **Step 3: Prove dependency direction**
...
- [ ] **Step 4: Run the complete offline workspace matrix**
...
- [ ] **Step 5: Commit the dependency-boundary change**
...
- [ ] **Step 2: Update repository command guidance**
