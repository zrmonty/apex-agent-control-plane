...
use super::{
    CommandInbox, DeliveryPolicy, ListCommandsPage, ListCommandsQuery, PendingCommand, PollTarget,
    RecordResult, ScopeAuthorizer, command_hash, is_recordable, resolve_delivery_status,
};
...
#[path = "inbox_postgres/listing.rs"]
mod listing;
...
impl CommandInbox for PostgresCommandInbox {
    ...
    fn list_commands(
        ...
        listing::list_commands(&mut self.client, query)
    }
